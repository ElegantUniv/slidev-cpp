...
<<< @/snippets/std-streams/c_io_basic.c c
...
<<< @/snippets/std-streams/cpp_io_basic.cpp cpp
...
<<< @/snippets/std-streams/cout_basic.cpp cpp
...
<<< @/snippets/std-streams/iomanip_numbers.cpp cpp

::right::

### 폭(width)과 정렬

<<< @/snippets/std-streams/iomanip_width.cpp cpp
...
<<< @/snippets/std-streams/stderr_c.c c
...
<<< @/snippets/std-streams/stderr_cpp.cpp cpp
...
<<< @/snippets/std-streams/cin_basic.cpp cpp
...
<<< @/snippets/std-streams/cin_getline_issue.cpp cpp
...
<<< @/snippets/std-streams/cin_getline.cpp cpp

::right::

### EOF까지 모든 줄 읽기

<<< @/snippets/std-streams/cin_eof_loop.cpp cpp
...
<<< @/snippets/std-streams/redirection_loop.cpp cpp
...
<<< @/snippets/std-streams/grader.cpp cpp
